    ...
    <section className="p-5">
      ...
      <table className="table w-full text-left">
        <thead className="border-t-2 border-b-2 border-gray-500 lg:text-xl">
          <tr>
            <th className="p1 lg:p-2">Title</th>
            ...
            <tr key={article.id} className="border-b border-t border-gray-300">
              ...
              <td className="p-3">
                <Link
                  ...
                  className="bg-green-600 text-white rounded-lg py-1 px-2 inline-block text-center mb-2 me-2 lg:me-3 hover:bg-gray-800 transition"
                >
                  Edit
                </Link>
